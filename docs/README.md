...
- Repositório do código fonte: (GitHub) https://github.com/ICEI-PUCMinas-PSG-SI-TI/icei-pucminas-psg-si-m-tiaw-2024-1-journey
- Documentos do projeto: (Google Drive) https://drive.google.com/drive/folders/1sPnPrt0jrj-8ihNOSrKQ5HOyrPEbveO6?usp=drive_link
- Gerenciamento do projeto: (Trello) https://trello.com/invite/tiawjourney/ATTI66a091fa4c1b3023e014755f51b9ce1e02E5C265
- Projeto de interface: (Figma) https://www.figma.com/files/team/1358076690961851188

**Gerenciamento do Projeto**
A equipe utiliza metodologias ágeis, tendo escolhido o Scrum como base para definição do processo de desenvolvimento.

A equipe está organizada da seguinte maneira:
 - Scrum Master: Mariana Yuna Campos Miyamoto
 - Product Owner: Sther Marinho Brito
...
O quadro kanban do grupo no Trello está disponível através da URL https://trello.com/b/1sbx1TOR/tiaw-journey e é apresentado, no estado atual, na Figura X. A definição desta estrutura se baseou na proposta feita por Littlefield (2016).
